...
variable "base_name" {
  type    = string
  default = "servicebus-topic-fanout-func"
}
...
locals {
  ...
  servicebus_namespace_name = "${var.base_name}-sb-${random_string.suffix.result}"
}
...
resource "azurerm_linux_function_app" "function_app" {
  ...
  app_settings = {
    ...
    ServiceBusConnection           = azurerm_servicebus_namespace_authorization_rule.auth.primary_connection_string
  }
}
