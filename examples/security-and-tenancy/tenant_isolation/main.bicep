...
param baseName string = 'tenantisolation'
  ...
  properties: {
    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        { name: 'TENANT_CODE', value: 'tenant-a' }
        { name: 'TENANT_TENANT_A_DB_URL', value: 'sqlite:///tenant-a.db' }
        { name: 'TENANT_TENANT_B_DB_URL', value: 'sqlite:///tenant-b.db' }
      ]
    }
  }
}
