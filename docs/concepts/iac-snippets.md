...
!!! tip "See also"
    The [Managed Identity (Storage)](../recipes/managed-identity-storage.md) and [Managed Identity (Service Bus)](../recipes/managed-identity-servicebus.md) recipes explain the app-level configuration in detail.
...
- [Reference Architecture Shapes](../architecture.md#reference-production-shapes)
