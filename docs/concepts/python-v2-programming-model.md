...
- Trigger and binding contracts: [Triggers and Bindings Overview](triggers-and-bindings-overview.md)
- Durable orchestration specifics: [Durable Functions Overview](durable-functions-overview.md)
- Identity settings and RBAC: [Identity-Based Connections](identity-based-connections.md)
- CI/CD and hosting choices: [Deployment Patterns](deployment-patterns.md)
