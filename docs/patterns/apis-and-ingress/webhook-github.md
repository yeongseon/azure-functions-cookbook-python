...
## Overview
This recipe documents the GitHub webhook receiver in `examples/apis-and-ingress/webhook_github/`.
...
- [Azure Functions HTTP trigger and webhook bindings](https://learn.microsoft.com/en-us/azure/azure-functions/functions-bindings-http-webhook-trigger)
