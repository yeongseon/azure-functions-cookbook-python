...
## Overview
This recipe documents the smallest practical HTTP-triggered Azure Function in `examples/http/hello_http_minimal/`.
...
## Architecture
```text
+-------------+        HTTP GET /api/hello?name=Ada        +-------------------+
|   Client    | -----------------------------------------> | Azure Functions   |
| (curl/web)  |                                            | Python Host       |
+-------------+                                            +---------+---------+
                                                                    |
                                                                    | route="hello"
                                                                    v
...
## Project Structure
```text
examples/http/hello_http_minimal/
├── function_app.py
├── host.json
